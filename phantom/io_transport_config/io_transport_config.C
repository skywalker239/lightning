...
io_transport_config_t::io_transport_config_t(const string_t& name, const config_t& config)
    : io_t(name, config),
      ...
      ring_sender_queue_size_(node_name(config.path, STRING("ring_sender_queue_size")), config.zconf),
      ring_sender_number_of_connections_(node_name(config.path, STRING("ring_sender_number_of_connections")), config.zconf),
      ring_sender_output_buffer_size_(node_name(config.path, STRING("ring_sender_output_buffer_size")), config.zconf),
      ring_sender_net_timeout_(node_name(config.path, STRING("ring_sender_net_timeout")), config.zconf),
